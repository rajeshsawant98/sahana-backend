...
class FriendService:
    ...
    def send_friend_request(self, sender_email: str, receiver_id: str) -> Dict[str, Any]:
        ...
        return self.friend_request_service.send_friend_request(sender_email, receiver_id)
    ...
    def get_friend_requests(self, user_email: str) -> Dict[str, List[FriendRequestWithProfile]]:
        ...
        return self.friend_request_service.get_friend_requests(user_email)

    def respond_to_friend_request(self, request_id: str, accept: bool, user_email: str) -> Dict[str, Any]:
        """Accept or reject a friend request"""
        return self.friend_request_service.respond_to_friend_request(request_id, accept, user_email)

    def cancel_friend_request(self, request_id: str, user_email: str) -> Dict[str, Any]:
        """Cancel a sent friend request"""
        return self.friend_request_service.cancel_friend_request(request_id, user_email)
    ...
    def get_friends_list(self, user_email: str) -> List[FriendProfile]:
        ...
        return self.friend_management_service.get_friends_list(user_email)
    ...
    def get_friendship_status(self, current_user_email: str, user_id: str) -> Dict[str, Any]:
        ...
        return self.friend_management_service.get_friendship_status(current_user_email, user_id)

    def remove_friendship(self, user_email: str, friend_email: str) -> Dict[str, Any]:
        """Remove a friendship between two users"""
        return self.friend_management_service.remove_friendship(user_email, friend_email)
    ...
    def search_users(self, search_term: str, user_email: str, limit: int = 20) -> List[UserSearchResult]:
        ...
        return self.user_discovery_service.search_users(search_term.strip(), user_email, limit)
    ...
    def get_user_suggestions(self, user_email: str, limit: int = 10) -> List[UserSearchResult]:
        ...
        return self.user_discovery_service.get_user_suggestions(user_email, limit)
